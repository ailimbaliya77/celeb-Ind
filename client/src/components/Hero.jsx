...
function Hero() {
  ...
  return (
    <div className="relative text-pink-800 overflow-x-scroll">
      <div className="absolute inset-0 bg-cover bg-center transform transition-transform duration-500 ease-out" style={{ backgroundImage: `url(${img1})`}} ></div>
      <div className="container mx-auto px-4  sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 relative">
        <div className="text-center max-w-3xl mx-auto">
          <h1
          ref={headingRef}
          className="text-3xl sm:text-4xl  md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-white">Experience the Magic of Indian Weddings</h1>
          <p 
          className="text-base sm:text-lg font-bold md:text-xl mb-7 sm:mb-8 px-4 text-white leading-relaxed ">
