        ...
        <div className="mt-6 sm:mt-8 space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  className="block w-full rounded-md border border-gray-300 px-3 py-2 pl-10 placeholder-gray-500 focus:border-pink-500 focus:outline-none focus:ring-pink-500 text-sm sm:text-base disabled:opacity-50"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  className="block w-full rounded-md border border-gray-300 px-3 py-2 pl-10 pr-10 placeholder-gray-500 focus:border-pink-500 focus:outline-none focus:ring-pink-500 text-sm sm:text-base disabled:opacity-50"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
            <div className="flex items-center">
              <input
                ...
                disabled={loading}
                className="h-3 w-3 sm:h-4 sm:w-4 rounded border-gray-300 text-pink-600 focus:ring-blue-500 disabled:opacity-50"
              />
          ...
          <div>
            <button
              ...
              disabled={loading}
              className="group relative flex w-full justify-center rounded-md border border-transparent bg-pink-600 py-2 px-4 text-xs sm:text-sm font-medium text-white hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                <LogIn className={`h-4 w-4 sm:h-5 sm:w-5 text-pink-500 group-hover:text-pink-400 ${loading ? 'animate-pulse' : ''}`} />
              </span>
        ...
        <div className="flex flex-col w-full max-w-sm space-y-4 mx-auto">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button 
              ...
              disabled={loading}
              className="flex items-center justify-center py-2 px-4 rounded-md bg-pink-400 hover:bg-pink-500 text-white disabled:opacity-50"
            >
