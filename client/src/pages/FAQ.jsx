  ...
  const faqCategories = [
    {
      ...
      questions: [
        {
          question: "What is WeddingTour?",
          answer: "WeddingTour is a platform that helps couples create ticketed wedding experiences, allowing them to manage guest lists, collect payments, and organize their special day seamlessly."
        },
        {
