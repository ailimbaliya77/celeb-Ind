        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg h-full">
              ...
              <p className="text-gray-700 italic mb-6 text-sm sm:text-base">"Being welcomed into an Indian family's wedding celebration was the highlight of our trip to India. WeddingTour handled everything perfectly, from our attire to helping us understand the ceremonies."</p>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg h-full">
              ...
              <p className="text-gray-700 italic mb-6 text-sm sm:text-base">"As someone interested in world cultures, attending an Indian wedding through WeddingTour was an unparalleled experience. It gave me insights into Indian family life that no tourist attraction could provide."</p>
              <div className="flex items-center">
